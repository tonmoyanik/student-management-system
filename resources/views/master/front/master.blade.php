...
<body>
    ...
    <footer class="pt-5 pb-4 bg-dark">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card card-body rounded-0 bg-dark text-white">
                        <h4>About Institute</h4>
                        <hr/>
                        <p>Searchley uses functional cookies and non-personalized content. Click 'OK' to allow us and our partners!</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card card-body rounded-0 bg-dark text-white" >
            ...
            <div class="row">
                <div class="col-12">
                    <p class="text-white text-center mb-0">Copyright@2022, All Rights Reserved by BASIS SEIP PHP</p>
                </div>
            </div>
        </div>
    </footer>
